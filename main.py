...
if(__name__ == '__main__'):
    ...
    parser.add_argument("-stock", default='NASDAQ 100', type=str, help="Name of the stock (market)")
    print(parser)
    ...
    simulator.simulateNewStrategy('TActorCritic', stock, numberOfEpisodes=50, showPerformance=True, saveStrategy=False)
